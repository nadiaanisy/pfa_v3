    ...
    >
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <motion.div variants={item}>
          ...
          <p className="text-slate-500 dark:text-slate-400">Track every penny and understand your spending habits.</p>
          ...
          <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
            ...
            >
              <DialogHeader>
                ...
                <DialogDescription>
                  Record a new transaction. Link it to an income source.
                </DialogDescription>
              </DialogHeader>
